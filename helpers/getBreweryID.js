...
//searches the BreweryDB /breweries endpoint
let getBreweryIDbreweryDB = (breweryName) => {
  ...
  //take the returned brewery object and get the id from it
  return rp(options);
};

module.exports.getBreweryIDbreweryDB = getBreweryIDbreweryDB;
